...
def calibrate():
    ...
    circles = [
        ...
        (SCREEN_WIDTH - border, border),
        (border, SCREEN_HEIGHT / 2),
        (SCREEN_WIDTH / 2, SCREEN_HEIGHT / 2),
        (SCREEN_WIDTH - border, SCREEN_HEIGHT / 2),
        (border, SCREEN_HEIGHT - border),
        (SCREEN_WIDTH / 2, SCREEN_HEIGHT - border),
                ...
                for i, val in enumerate(circles):
                    ...
                    if (
                        ...
                        if i == 4:  # middle one, must be first
                            ...
                            scales.append(
                                (
                                    (trans[0] + references[i][0]) / xvec,
                                    (trans[1] + references[i][1]) / yvec,
                                    1,
                                )
                            )
                        ...
                        if count == 9:
                            ...
                            final_scales = tuple(
                                sum(x) / num_tuples for x in zip(*scales)
                            )
